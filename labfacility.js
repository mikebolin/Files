...
(function (window, document) {
	const AccessRights = "Full";
class LabFacility {
	constructor() {
		this._LabModal = $('<div class="modal fade in" id="labModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block; padding-right: 17px;"><div class="modal-dialog" id="modalDialogProcessingTwo"><div class="modal-content" id="modalContentProcessingTwo"><div class="modal-header"><div><h3 class="modal-title" id="mTitle"><span id="titleForFac">Change Primary Lab</span></h3></div></div><div class="modal-body"><div class="row"><div class="col-md-4"><label>*New Primary Lab</label><div class="input-group date" id="EffDateChangePrimLab"> <input class="form-control datepicker" id="EffDateChangePrimLabMask" name="EffDateChangePrimLabMask" placeholder="MM/DD/YYYY" type="text" value="" maxlength="10" autocomplete="off" data-bv-field="EffDateChangePrimLabMask"> <span class="input-group-addon"> <span class="glyphicon-calendar glyphicon" id="spneffDate"></span> </span></div></div><div class="col-md-3"> <label>Termination Date</label> <div class="form-group"> <div class="input-group date" id="TermDateChangePrimLab"> <input class="form-control datepicker callautofilldatetime" id="TermDateChangePrimLabMask" name="TermDateChangePrimLab" placeholder="MM/DD/YYYY" type="text" value="" maxlength="10" autocomplete="off" data-bv-field="TermDateChangePrimLab"> <span class="input-group-addon"> <span class="glyphicon-calendar glyphicon"></span> </span> </div><small data-bv-validator="date" data-bv-validator-for="PCPTermDate" class="help-block" style="display: none;">Invalid Date.</small><small data-bv-validator="compareDate" data-bv-validator-for="TermDateChangePrimLab" class="help-block" style="display: none;">Terminated date should be greater than the Effective date.</small></div></div></div><div><div id="divRoleProcessing" class="icon-loading icon-loading-small paddig-right-150 hide"></div><button type="button" id="btnPrimaryLabDoneChange" name="" class="btn btn-primary"> Done</button><button type="button" class="btn btn-danger" id="closeLabModal">Close</button></div></div></div></div></div>');
		this._FacilityModal = $('<div class="modal fade in" id="facModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block; padding-right: 17px;"> <div class="modal-dialog" id="modalDialogProcessingTwo"> <div class="modal-content" id="modalContentProcessingTwo"> <div class="modal-header"> <div> <h3 class="modal-title" id="mTitle"><span id="titleForFac">Change Primary Facility</span></h3></div></div><div class="modal-body"> <div class="row"> <div class="col-md-4"> <label>*New Primary Facility</label> <div class="form-group"> <select class="form-control selectpicker" data-live-search="true" id="ddlNewProviderFromChangeFacility" name="ddlNewProviderFromChangeFacility" data-bv-field="ddlNewProviderFromChangeFacility" style="display: none;"> <option value="0">--Select--</option> </select> <div class="btn-group bootstrap-select form-control"> <button type="button" style="font-weight:normal;height:30px;" class="btn dropdown-toggle selectpicker skipDisable btn-default" data-toggle="dropdown" data-id="ddlNewProviderFromChangeFacility" title="--Select--" aria-expanded="false"> <span class="filter-option pull-left">--Select--</span>&nbsp;<span class="caret"></span> </button> <div class="dropdown-menu open" style="max-height: 260px; overflow: hidden; min-height: 38px; z-index: 1000;"> <div class="bootstrap-select-searchbox"> <input type="text" autocomplete="off" data-dataurl="" data-ctrlid="ddlNewProviderFromChangeFacility" class="input-block-level items form-control skipDisable"> </div><ul class="dropdown-menu inner selectpicker" role="menu" style="max-height: 215px; overflow-y: auto; min-height: 0px; z-index: 1000;"> <li rel="0" class="selected active"><a tabindex="0" class="" style="min-height:20px;"><span class="text">--Select--</span> <i class="glyphicon glyphicon-ok icon-ok check-mark"></i></a></li></ul> </div></div><small data-bv-validator="dropdown" data-bv-validator-for="ddlNewProviderFromChangeFacility" class="help-block" style="display: none;">New Provider is required.</small></div></div><div class="col-md-3"> <label>*Effective Date</label> <div class="form-group"> <div class="input-group date" id="EffDateChangePrimFacility"> <input class="form-control datepicker callautofilldatetime" id="EffDateChangePrimFacilityMask" name="EffDateChangePrimFacilityMask" placeholder="MM/DD/YYYY" type="text" value="" maxlength="10" autocomplete="off" data-bv-field="EffDateChangePrimFacilityMask"> <span class="input-group-addon"> <span class="glyphicon-calendar glyphicon" id="spneffDate"></span> </span> </div><small data-bv-validator="notEmpty" data-bv-validator-for="EffDateChangePrimFacility" class="help-block" style="display: none;">Effective Date is required.</small><small data-bv-validator="date" data-bv-validator-for="EffDateChangePrimFacility" class="help-block" style="display: none;">Invalid date.</small></div></div><div class="col-md-3"> <label>Termination Date</label> <div class="form-group"> <div class="input-group date" id="TermDateChangeFacility"> <input class="form-control datepicker callautofilldatetime" id="TermDateChangePrimFacilityMask" name="TermDateChangeFacility" placeholder="MM/DD/YYYY" type="text" value="" maxlength="10" autocomplete="off" data-bv-field="TermDateChangeFacility"> <span class="input-group-addon"> <span class="glyphicon-calendar glyphicon"></span> </span> </div><small data-bv-validator="date" data-bv-validator-for="PCPTermDate" class="help-block" style="display: none;">Invalid Date.</small><small data-bv-validator="compareDate" data-bv-validator-for="TermDateChangeFacility" class="help-block" style="display: none;">Terminated date should be greater than the Effective date.</small></div></div></div><div> <div id="divRoleProcessing" class="icon-loading icon-loading-small paddig-right-150 hide"></div><button type="button" id="btnPrimaryFacDoneChange" name="" class="btn btn-primary"> Done</button> <button type="button" class="btn btn-danger" id="closeFacModal">Close</button> </div></div></div></div></div>');
		this._JsonTableData = '';
	...
	set JsonTableData(data) { this._JsonTableData = data; } static get AccessRights() { return AccessRights; } get dropdownOutterHtml() { return this._dropdownOutterHtml; } get dataTable() { return this._dataTable; } get dropdownInnerHtml() { return this._dropdownInnerHtml; } get isDropdownEnabled() { return this._isDropdownEnabled; } set dropdownOutterHtml(newHtml) { this._dropdownOutterHtml = newHtml; } set dataTable(newHtml) { this._dataTable = newHtml; } set dropdownInnerHtml(newValue) { this._dropdownInnerHtml = newValue; } set isDropdownEnabled(newValue) { this._isDropdownEnabled = newValue; }

	showChangePrimaryLabModal() {
		$("#EffDateChangePrimLab").mask("99/99/9999"); $("#EffDateChangePrimLab").datepicker({});
		$("#TermDateChangePrimLab").mask("99/99/9999"); $("#TermDateChangePrimLab").datepicker({});
		this._LabModal.modal('show');
		$("#TermDateChangePrimLab").selectpicker('refresh');

	}
	hideChangePrimaryLabModal() {
		this._LabModal.modal('hide');
	}
	showChangePrimaryFacilityModal() {
		this._FacilityModal.modal('show');
	}
	hideChangePrimaryFacilityModal() {
		this._FacilityModal.modal('hide');
	}
	validator() {
	...
	setEventListeners() {
		...
		$(this._LabModal).on('show.bs.modal', function () {
		}.bind(this));
		...
		window.addEventListener("click", (event) => {
			...
			if (id === 'LabLookup') {
				$("#EffDateChangePrimLabMask").mask("99/99/9999"), $("#EffDateChangePrimLabMask").datepicker({})
				$("#EffDateChangePrimLabMask").mask("99/99/9999"); $("#EffDateChangePrimLabMask").datepicker({});
	...
	addDropdownToDOM(val) {
		if (val === 'blue')
		{
			if (this._isDropdownEnabled === 'true') {
				this._dropdownOutterHtml.appendTo($('.panel-info')).after(this.addInnerHtmlToDropdown()).after(this.runSetupCalls());
			}
		}
		if (val === 'green')
		{
			if (this._isDropdownEnabled === 'true') {
				this._dropdownOutterHtmlGreen.appendTo($('.panel-info')).after(this.addInnerHtmlToDropdown()).after(this.runSetupCalls());
			}
		}
	...
	addInnerHtmlToDropdown() {
		this._dropdownInnerHtml.appendTo("#divPrimaryFacilityLab"), $("#LabFacilityEffDatePicker").mask("99/99/9999"), $("#LabFacilityEffDatePicker").datepicker({}), $("#LabFacilityTermDatePicker").mask("99/99/9999"), $("#LabFacilityTermDatePicker").datepicker({}), this._dataTable = $("#dtPrimaryLabFacility").DataTable({ paging: !0, destroy: !0, pagingType: "input" }), $("#tbl_edit").text("Edit"), $("#tbl_delete").text("Delete"), $("#tbl_edit").removeClass(), $("#tbl_delete").removeClass(), $("#tbl_edit").addClass("sorting_disabled"), $("#tbl_delete").addClass("sorting_disabled"), $("#tbl_delete").selectpicker("refresh"), $("#tbl_edit").selectpicker("refresh");
	}
	enableAll() {
	...
	setAccessRights() {
		switch (LabFacility.AccessRights) {
			case 'Full':{this._canDelete = true; this._canEdit = true; this._canAdd= true; $("#LabFacilityEffDatePicker").find("*").each(function (index) { $(this).attr('readonly', false); });$("#LabFacilityEffDatePicker").find("*").each(function (index) { $(this).attr('disabled', false); });break;}
			case 'Readonly': {this._canReadonly = true; this._canDelete = false; this._canEdit = false; this._canAdd = false;			 $("#divPrimaryFacilityLab").find("*").each(function (index) { $(this).attr('readonly', true); }); $("#divPrimaryFacilityLab").find("*").each(function (index) { $(this).attr('disabled', true); }); break; }
	...
	addListToTable(data) {
		...
		for (var i = 0; i < myData.length; i++) {
			...
			this._dataTable.row.add([
				'<a href="javascript:EditMemberPCPinfo(' + obj.MemberPrimaryFacilityLabID + ')"><span class="glyphicon glyphicon-pencil"></span></a>',
				'<a href="javascript:EditMemberPCPinfo(' + obj.MemberPrimaryFacilityLabID + ')"><span class="error glyphicon glyphicon-trash"></span></a>',
	...
	addRow() {
		var addEditButton = $('<a href="javascript:EditMemberPCPinfo(321834)"><span class="glyphicon glyphicon-pencil"></span></a>');
		var addDeleteButton = $('<a href="javascript:EditMemberPCPinfo(328086)"><span class="error glyphicon glyphicon-trash"></span></a>');
		...
		this._dataTable.row.add([
			'<a href="javascript:EditMemberPCPinfo(321834)"><span class="glyphicon glyphicon-pencil"></span></a>',
			'<a href="javascript:EditMemberPCPinfo(328086)"><span class="error glyphicon glyphicon-trash"></span></a>',
			$('#LabFacilityEffDatePicker').val(),
			$('#LabFacilityTermDatePicker').val(),
			$('#PrimaryFacilityID').val(),
			locationID1,
